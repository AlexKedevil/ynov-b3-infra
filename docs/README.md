...
| Backlog / sprints agile | [project_management/backlog_sprints.md](project_management/backlog_sprints.md) | Fait |
| Guide board Trello | [project_management/trello_board_guide.md](project_management/trello_board_guide.md) | Fait |
